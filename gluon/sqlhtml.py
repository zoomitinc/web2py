...
def bootstrap3(form, fields):
    ...
    for id, label, controls, help in fields:
        ...
        if isinstance(controls, basestring) or isinstance(controls, int):
            _controls = DIV(controls, _help, _class='form-control-static')
...
def formstyle_bootstrap3(form, fields):
    ...
    for id, label, controls, help in fields:
        ...
        _help = SPAN(help, _class='help-block')
        # embed _help into _controls
        _controls = DIV(controls, _help, _class='col-lg-5')
        # submit unflag by default
        _submit = False
        if isinstance(controls, INPUT):
        ...
        if isinstance(label, LABEL):
            label['_class'] = 'col-lg-4 control-label'
            label['_style'] = 'word-wrap: break-word;'
